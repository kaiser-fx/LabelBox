...
# Common date patterns on Indian product labels (supporting 2-digit and 4-digit years)
_DATE_PATTERNS = [
    # MM/YYYY or MM/YY or MM-YYYY or MM-YY
    re.compile(r"\b(0[1-9]|1[0-2])[/\-]((?:19|20)?\d{2})\b"),
    # DD/MM/YYYY or DD/MM/YY or DD-MM-YYYY or DD-MM-YY
    re.compile(r"\b(0[1-9]|[12]\d|3[01])[/\-](0[1-9]|1[0-2])[/\-]((?:19|20)?\d{2})\b"),
    # Month-name YYYY or YY (e.g. "Jan 2024", "March 2023", "Oct 25")
    re.compile(
